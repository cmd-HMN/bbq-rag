...
class ConfigParseError(BaseBBQEngineException):
    ...
    def __init__(
        self, message: str = "Failed to parse YAML configuration file."
    ) -> None:
        super().__init__(message)
...
class BaseModelConfigLoadError(BaseBBQEngineException):
    ...
    def __init__(
        self, message: str = "Failed to load explicit base configuration."
    ) -> None:
        super().__init__(message)
...
class LoRAAdapterLoadError(BaseBBQEngineException):
    ...
    def __init__(
        self, message: str = "Failed to load and apply LoRA adapter weights."
    ) -> None:
        super().__init__(message)
